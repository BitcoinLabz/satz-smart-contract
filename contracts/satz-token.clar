...
(define-constant TOKEN_URI "https://raw.githubusercontent.com/Bitcoinlabz/SATZ-Smart-Contract/main/metadata/token-metadata.json") ;; Metadata URI pointing to a JSON file with token details
