...
(define-constant TOKEN_URI "https://raw.githubusercontent.com/Bitcoinlabz/SATZ-Smart-Contract/main/metadata/satz-metadata.json") ;; Metadata URI for token logo
